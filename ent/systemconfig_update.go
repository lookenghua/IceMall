...
func (scu *SystemConfigUpdate) SetRule(s string) *SystemConfigUpdate {
	scu.mutation.SetRule(s)
	return scu
}
...
func (scu *SystemConfigUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := scu.mutation.Rule(); ok {
...
// SetRule sets the "rule" field.
func (scuo *SystemConfigUpdateOne) SetRule(s string) *SystemConfigUpdateOne {
	scuo.mutation.SetRule(s)
	return scuo
}
...
func (scuo *SystemConfigUpdateOne) sqlSave(ctx context.Context) (_node *SystemConfig, err error) {
	...
	if value, ok := scuo.mutation.Rule(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: systemconfig.FieldRule,
